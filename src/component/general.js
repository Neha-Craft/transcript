      ...
      <div className="px-8 py-6 max-w-2xl">
        <div className="mb-8">
          <div className="mb-4">
            ...
            <p className="text-sm font-aeonik text-gray-600">
        ...
        <div className="mb-8">
          <div className="mb-4">
            <h3 className="text-base font-medium font-aeonik text-gray-900 mb-1">
              Main encounter language
            </h3>
            <p className="text-sm text-gray-600 font-aeonik">
              The language you most often speak with your patient
            </p>
          </div>
          <div className="relative">
            <select
        ...
        <div className="mb-8">
          <div className="mb-4">
            <h3 className="text-base font-medium text-gray-900 font-aeonik mb-1">
              Secondary encounter language
            </h3>
            <p className="text-sm text-gray-600 font-aeonik">
              Any other language you also speak with your patient
            </p>
          </div>
          <div className="relative">
            <select
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-medium font-aeonik text-gray-900 mb-1">
                Show the note template selector before each encounter
              </h3>
              <p className="text-sm text-gray-600 font-aeonik">
                Useful if you often switch note templates
              </p>
            </div>
            <button
        ...
        <div className="mb-8">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-600 font-aeonik">
              You can dictate punctuation explicitly or let Nabla detect it
              automatically
            </p>
          </div>
          <div className="relative">
        ...
        <div className="mb-8">
          <div className="mb-4">
            <h3 className="text-base font-aeonik font-medium text-gray-900 mb-1">
              Patient naming{" "}
              <span className="inline-flex font-aeonik items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                BETA
              </span>
            </h3>
            <p className="text-sm font-aeonik text-gray-600">
              Noun that will be used in the note to refer to the person that
              you're seeing
            </p>
          </div>
          <input
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-medium font-aeonik text-gray-900">
              Letter should be addressed to the patient
            </h3>
        ...
        <div className="mb-8 p-4 bg-orange-50 border border-orange-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 font-aeonik mb-2">
                Microphone used to listen to your encounters
              </p>
              <p className="text-sm font-aeonik text-orange-600  font-medium">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-base font-medium text-gray-900 mb-1 font-aeonik">
                Encounters saving duration
              </h3>
              <p className="text-sm text-gray-600 font-aeonik">
                Encounters will be automatically deleted 14 days after they've
                been created
              </p>
            </div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-medium font-aeonik text-gray-900 mb-1">
                Allow audio sharing after an encounter to improve the
                transcription
              </h3>
              <p className="text-sm text-gray-600 font-aeonik">
                You will need{" "}
